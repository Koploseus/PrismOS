...
import { parsePaymentHeader, verifyPayment, formatPaymentRequired, ENDPOINT_PRICING } from '../lib/yellow';
...
export function computePaymentMessage(channelId: Hex, nonce: bigint, agentBalance: bigint, prismosBalance: bigint): Hex {
